...
/**
 * Store the {@link CurrentPortfolio} under a new unique name, and display it to
 * the user as the <tt>CurrentPortfolio</tt>, which does not need a save, and
 * which reflects the new name just entered.
 * 
* <P>
...
@ActionRegistration(
        ...
        iconBase = "toolbarButtonGraphics/general/SaveAs24.gif"
)
@ActionReferences({
...
//    fFrame = aFrame;
     ...
     *
     * <P>
     * The name must have a non-zero trimmed length, and must be unique. If the
     * name entered by the user does not comply, then they are informed and
     * asked to re-input.
     */
    @Override
