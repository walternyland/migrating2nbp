...
/**
 * Present an alphabetical list of <tt>Portfolio</tt> names, from which the user
 * may choose one, which is then presented to the user as the
 * <tt>CurrentPortfolio</tt>.
 * 
* <P>
 * If the <tt>CurrentPortfolio</tt> being replaced has unsaved edits, then the
 * appropriate <tt>Save</tt> or <tt>SaveAs</tt> action is called before this
 * action executes.
 * 
* <P>
...
@ActionID(
        category = "File",
        id = "hirondelle.stocks.quotes.OpenAction"
)
@ActionRegistration(
        displayName = "#CTL_OpenAction",
        iconBase = "toolbarButtonGraphics/general/Open24.gif"
)
@ActionReferences({
...
public final class FileOpenAction extends AbstractAction {
     ...
     */
    public FileOpenAction() //  public FileOpenAction(
...
//  private EditSaver fEditSaver;
    ...
    /**
     * Returns the user selection for an existing Portfolio name, as selected
    ...
    private String askForSelectedPortfolio() {
        ...
        Object result = JOptionPane.showInputDialog(
                null, "Please select a Portfolio:", title,
